    ...
    <div class="card-container">
        <div class="card-body">
            <table class="table">
                ...
                <tbody class="detail_table">
                        ...
                        <tr>
                            <th>팝업 작성일</th>
                            <td><fmt:formatDate value="${item.popDatetime}" pattern="yyyy-MM-dd HH:mm" /></td>
                        </tr>
                        <tr>
                            <th>팝업 컨텐츠</th>
                            <td>${item.content}</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <c:forEach var="attach" items="${item.attach}">
                                    ...
                                    <c:if test="${attach.filename != null}">
                                        <img src="/upload/image/popup/${attach.savedFilename}" />
                                    </c:if>
        ...
        <div class="card-footer">
            <div class="btn-container">
                <div class="btn btn-primary" onclick="location.href = '${contextPath}/popup/update/${item.code}'">
                    수정
                </div>
