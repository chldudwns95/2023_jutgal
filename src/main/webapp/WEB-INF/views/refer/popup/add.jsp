...
<form method="post" enctype="multipart/form-data" action="/popup/add">

    <div class="sub-header-container">
        <h1>팝업 추가</h1>
        <p>팝업 관리 &#62; 팝업 통합 관리 &#62; 팝업 추가</p>
    </div>
    <div class="card-container">
        <div class="card-body">
            ...
            <table class="table">
                ...
                <tr>
                    <th>팝업 컨텐츠</th>
                    <td><textarea name="content" cols="10" rows="10" placeholder="콘텐츠 내용을 입력하세요"></textarea></td>
                </tr>
                <tr>
                    <th>공개여부</th>
                    <td>
