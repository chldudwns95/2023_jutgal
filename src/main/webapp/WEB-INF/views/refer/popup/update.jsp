...
<form method="post" action="/popup/update/${item.code}" enctype="multipart/form-data">
        ...
        <div class="card-container">
            <div class="card-body">
                ...
                <table class="table">
                    ...
                    <tr>
                        <th>팝업 컨텐츠</th>
                        <td><textarea name="content" cols="10" rows="10" placeholder="콘텐츠 내용을 입력하세요">${item.content}</textarea></td>
                    </tr>
                    <tr>
                        <th>공개여부</th>
                        <td>
                        ...
                        <td>
                            <ul>
                                <c:forEach var="attach" items="${item.attach}">
                                    ...
                                    <c:if test="${attach.filename != null}">
                                        <li>
                                            <img src="/upload/image/popup/${attach.savedFilename}" width="100px"/>
                                            ${attach.filename}
